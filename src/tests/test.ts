...
async function runTests() {
  ...
  const getResult = await request<Post>(
  ...
  const putResult = await request<Post>(
    "https://jsonplaceholder.typicode.com/posts/1",
    {
      method: "PUT",
      body: JSON.stringify({
  ...
  const queryResult = await request<Post[]>(
    "https://jsonplaceholder.typicode.com/posts",
    {
      method: "GET",
      query: {
  ...
  const headerResult = await request<Post>(
    "https://jsonplaceholder.typicode.com/posts/1",
    {
      headers: {
  ...
  const errorResult = await request<Post>(
